...
ALTER TABLE files ADD COLUMN storage_node_id VARCHAR(32);

-- Add file_status column to files table
ALTER TABLE files ADD COLUMN file_status VARCHAR(20) DEFAULT 'created';

-- Add synced_at column to files table
ALTER TABLE files ADD COLUMN synced_at TIMESTAMP WITH TIME ZONE;
